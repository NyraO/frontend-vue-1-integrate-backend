<template>
  <BaseModal
    :show="show"
    :title="isEdit ? 'Edit Input Node' : 'Create Input Node'"
    ...
    <form @submit.prevent="handleSubmit" class="form">
      <div class="form-group">
        ...
        <input
          ...
          type="text"
          required
          placeholder="e.g., User Events Input"
        />
      </div>
...
import type { InputCreate } from '@/services/types'

const props = defineProps<{
  show: boolean
  isEdit?: boolean
  initialData?: Partial<InputCreate>
}>()

const emit = defineEmits(['close', 'submit'])

const form = ref<InputCreate>({
  name: '',
  description: '',
  topic: '',
